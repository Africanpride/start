      ...
      <header class="header white-bg fixed-top d-flex align-content-center flex-wrap">
          <!-- Logo -->
          <div class="logo">
              <a href="{{ route('dashboard') }}" class="default-logo">
                  <img src=" {{ $business->getFirstMediaUrl('logo', 'mobile-logo') ?? asset('backend/assets/img/logo.png') }}"
                      alt="">
              </a>
              <a href="{{ route('dashboard') }}" class="mobile-logo">
                  <img src="{{ $business->getFirstMediaUrl('logo', 'mobile-logo') ?? asset('backend/assets/img/mobile-logo.png') }}"
                      alt="">
              </a>
          </div>
          <!-- End Logo -->
                                      ...
                                      <div class="main-header-search">
                                          <form action="#" class="search-form">
                                              <div class="theme-input-group header-search">
                                                  ...
                                                  <button type="submit">
                                                      <img src=" {{ asset('backend/assets/img/svg/search-icon.svg ') }}"
                                                          alt="" class="svg">
                                                  </button>
                                              </div>
                                          </form>
                                  ...
                                  <li class="d-none d-lg-flex">
                                      ...
                                      <div class="main-header-btn ml-md-1">
                                          <a href="{{ route('articles.create')}}" class="btn">
                                              <img src="{{ asset('backend/assets/img/svg/plus_white.svg') }}" alt=""
                                                  class="svg mr-1"> Create New Article</a>
                                      </div>
                                  ...
                                  <li class="ml-0">
                                      ...
                                      <div class="main-header-language">
                                          ...
                                          <div class="dropdown-menu style--three">
                                              <a href="#">
                                                  <span><img src="{{ asset('backend/assets/img/usa.png') }}"
                                                          alt=""></span>
                                                  English
                                              </a>

                                              <a href="#">
                                                  <span><img src="{{ asset('backend/assets/img/france.png') }}"
                                                          alt=""></span>
                                                  French
                                              </a>
                                      ...
                                      <div class="main-header-user">
                                          <a href="#" class="d-flex align-items-center" data-toggle="dropdown">
                                              <div class="avatar mr-20">
                                                  @auth
                                                  <img src="{{ '/backend/assets/img/avatar/'. Auth::user()->profile->avatar }}"
                                                      alt="">
                                          ...
                                          <div class="dropdown-menu">
                                              ...
                                              <a href="{{ route('profile.show', [Auth::user()->profile->uuid]) }}">My
                                                  Profile</a>
