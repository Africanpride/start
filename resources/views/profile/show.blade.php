    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="user-profile-img">
                <div class="cover-img">
                     <img src="{{ asset('backend/assets/img/svg/banner.svg') }}" class="w-100" alt="">

                     {{-- <!-- Upload Photo -->
                     <div class="upload-button">
                         <img src="{{ asset('backend/assets/img/svg/gallery.svg') }}" alt="" class="svg mr-2">
                 ...
                 <div class="user-profile-nav d-flex justify-content-xl-between align-items-xl-center flex-column flex-xl-row">
                     ...
                     <div class="profile-info d-flex align-items-center">
                         <div class="profile-pic mr-3">
                             <img src="{{ '/backend/assets/img/avatar/'. $profile->avatar }}" alt="">
                         ...
                         <ul class="nav profile-nav-tabs">
                             <li>
                                 <a class="active pr-0 pl-2 pl-xl-30">
                                     <span class="chat">
                                         <img src="{{ asset('backend/assets/img/svg/chat-icon.svg') }}" alt="" class="svg">
                                     </span>
                                 </a>
                             </li>
                             <li>
                                 <a class="conncetion" href="connection.html">
                                     <div class="btn-circle mr-20">
                                         <img src="{{ asset('backend/assets/img/svg/user-check.svg') }}" alt="" class="svg">
                                     </div>
                                     <div class="font-14">
                                         <h4>154</h4>
                             ...
                             <li>
                                 <a class="p_nav-link" href="gallery.html">My Articles</a>
                             </li>
                             <li>
                                 <a class="p_nav-link" href="news-feed.html">Comments</a>
                             </li>
                         </ul>
             ...
             <div class="mt-30">
                 ...
                 <div class="profile-completion d-flex align-items-center justify-content-between">
                     ...
                     <div class="edit-profile-btn pr-1">
                         ...
                         <img src="{{ asset('backend/assets/img/svg/writing.svg') }}" alt="" class="svg">
                         </a>
                     </div>
                 ...
                 <div class="card">
                     <div class="p-30">
                         <div class="about-myself mt-2 pb-2">
                             <h4 class="mb-3">About {{ $profile->user->first_name .' '. $profile->user->last_name }}</h4>
                                       ...
                                       <div class="overview">
                                          ...
                                          <ul class="p_overview-list list-unstyled">
                                                <li>
                                                   <div class="d-flex">
                                                      <div class="img mr-3">
                                                            <img src="{{ asset('backend/assets/img/png-icon/themelooks.png') }}" alt="">
                                                      </div>
                                                      <div class="content">
                                                ...
                                                <li>
                                                   <div class="d-flex">
                                                      <div class="img mr-3">
                                                            <img src="{{ asset('backend/assets/img/png-icon/fci.png') }}" alt="">
                                                      </div>
                                                      <div class="content">
                                                            Studied SEIP at
                                                ...
                                                <!-- <li>
                                                   <div class="d-flex">
                                                      <div class="img mr-3">
                                                            <img src="../../../assets/img/png-icon/place.jpg" alt="">
                                                      </div>
                                                      <div class="content">
                                                            Lives in
                                       ...
                                       <ul class="p_work-list list-unstyled">
                                          ...
                                          <li>
                                             <div class="work-content">
                                                <div class="d-flex">
                                                      <div class="img mr-3">
                                                         <img src="../../../assets/img/png-icon/themelooks.png" alt="">
                                                      </div>
                                                      <div class="content">
                                          ...
                                          <li>
                                             <div class="work-content">
                                                <div class="d-flex">
                                                      <div class="img mr-3">
                                                         <img src="../../../assets/img/png-icon/freelancer.png" alt="">
                                                      </div>
                                                      <div class="content">
                                       ...
                                       <ul class="p_education-list list-unstyled">
                                          ...
                                          <li>
                                             <div class="work-content">
                                                <div class="d-flex">
                                                      <div class="img mr-3">
                                                         <img src="../../../assets/img/png-icon/fci.png" alt="">
                                                      </div>
                                                      <div class="content">
                                                         <a href="#">
                                          ...
                                          <li>
                                             <div class="work-content">
                                                <div class="d-flex">
                                                      <div class="img mr-3">
                                                         <img src="../../../assets/img/png-icon/edu.png" alt="">
                                                      </div>
                                                      <div class="content">
