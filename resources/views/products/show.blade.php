                       ...
                       <div class="row">
                             ...
                             <div class="pd-img-wrapp position-relative mb-5 mb-lg-0">
                                ...
                                <div id="gal1">
                                   <a href="#" data-image="{{ asset('backend/assets/img/product/product-details.jpg') }} " data-zoom-image="{{ asset('backend/assets/img/product/product-details-large.jpg') }} ">
                                      <img id="img_02" src=" {{ asset('/backend/assets/img/product/product-details.jpg') }} " alt="" />
                                   </a>

                                   <a href="#" data-image="{{ asset('backend/assets/img/product/product-details-2.jpg') }} " data-zoom-image="{{ asset('backend/assets/img/product/product-details-2-large.jpg') }} ">
                                      <img id="img_03" src=" {{ asset('/backend/assets/img/product/product-details-2.jpg') }} " alt="" />
                                   </a>

                                   <a href="#" data-image="{{ asset('backend/assets/img/product/product-details-3.jpg') }} " data-zoom-image="{{ asset('backend/assets/img/product/product-details-3-large.jpg') }} ">
                                      <img id="img_04" src=" {{ asset('/backend/assets/img/product/product-details-3.jpg') }} " alt="" />
                                   </a>
                                </div>
                          ...
                          <div class="col-lg-8">
                             ...
                             <div class="product-details-content position-relative">
                                <!-- Product Title -->
                                <h4 class="product_title">{{ $product->name ?? ' Product Name '}}</h4>
                                <!-- End Product Title -->

                                <!-- Product Price -->
                                <p class="price">
                                   <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">{{ $product->price_symbol }} </span>{{ $product->specifications()->price ?? '100.00'}}</span>
                                </p>
                                <!-- End Product Price -->
                                ...
                                <div class="product-review d-flex align-items-center">
                                   ...
                                   <div class="star-rating">
                                      <a href="#"><img src=" {{ asset('/backend/assets/img/svg/star.svg') }} "" alt="" class="svg"></a>
                                      <a href="#"><img src=" {{ asset('/backend/assets/img/svg/star.svg') }} "" alt="" class="svg"></a>
                                      <a href="#"><img src=" {{ asset('/backend/assets/img/svg/star.svg') }} "" alt="" class="svg"></a>
                                      <a href="#"><img src=" {{ asset('/backend/assets/img/svg/star2.svg') }} "" alt="" class="svg"></a>
                                      <a href="#"><img src=" {{ asset('/backend/assets/img/svg/star2.svg') }} "" alt="" class="svg"></a>
                                   </div>
                                   <!-- End Product Rating -->
                                </div>
                          ...
                          <div class="row">
                                ...
                                <div class="product-grid-item mb-30">
                                      <div class="product-img mb-3">
                                         <a href="product-details.html">
                                            <img src=" {{ asset('/backend/assets/img/product/pg1.png')  }}"class="w-100" alt="">
                                         </a>
                                      </div>
                             ...
                             <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                ...
                                <div class="product-grid-item mb-30">
                                   <div class="product-img mb-3">
                                      <a href="product-details.html">
                                         <img src=" {{ asset('/backend/assets/img/product/pg2.png')  }}"class="w-100" alt="">
                                      </a>
                                   </div>
                                   <div class="product-content">
                                      <h6 class="mb-10">$24</h6>
                             ...
                             <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                ...
                                <div class="product-grid-item mb-30">
                                   <div class="product-img mb-3">
                                   <a href="product-details.html">
                                      <img src=" {{ asset('/backend/assets/img/product/pg3.png')  }}"class="w-100" alt="">
                                   </a>
                                   </div>
                                   <div class="product-content">
                                      <h6 class="mb-10">$24</h6>
                             ...
                             <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                ...
                                <div class="product-grid-item mb-30">
                                   <div class="product-img mb-3">
                                   <a href="product-details.html">
                                      <img src=" {{ asset('/backend/assets/img/product/pg4.png')  }}"class="w-100" alt="">
                                   </a>
                                   </div>
                                   <div class="product-content">
                                      <h6 class="mb-10">$24</h6>
                             ...
                             <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                ...
                                <div class="product-grid-item mb-30">
                                   <div class="product-img mb-3">
                                      <a href="product-details.html">
                                         <img src=" {{ asset('/backend/assets/img/product/pg5.png')  }}"class="w-100" alt="">
                                      </a>
                                   </div>
                                   <div class="product-content">
                                      <h6 class="mb-10">$24</h6>
                             ...
                             <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                ...
                                <div class="product-grid-item mb-30">
                                   <div class="product-img mb-3">
                                   <a href="product-details.html">
                                      <img src=" {{ asset('/backend/assets/img/product/pg6.png')  }}"class="w-100" alt="">
                                   </a>
                                   </div>
                                   <div class="product-content">
                                      <h6 class="mb-10">$24</h6>
