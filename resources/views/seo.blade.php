            ...
            <div class="form-element touchspin mb-30">
                ...
                <form method="POST" action="{{ route('business.store'), $business->id }}" id="testForm"
                    ...
                    <div class="form-group mb-4">
                        <label for="textarea1" class="font-16 bold black mb-10">{{__('Please provide a description of your business or organization here.')}}</label>
                        <textarea id="textarea1" name="business_description" class="theme-input-style style--seven" placeholder="{{ __($business->business_description ?? 'Business/Organization description here.')}}">{{ old('business_description', optional($business)->business_description) }}</textarea>
                        ...
                        <div class="vertical-form mb-30">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="business_name" class="form-control pl-1" placeholder="{{ __($business->business_name ?? 'Business/Organization Name here.')}}" value="{{ old('business_name', optional($business)->business_name) }}">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                ...
                                <!-- Form Group -->
                                <div class="form-group">
                                    <label class="font-14 bold mb-2">{{ __('Your Email (For official communications)')}}</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="business_email" class="form-control pl-1" placeholder="{{ __($business->business_email ?? 'Business/Organization Official Email.')}}" value="{{ old('business_email', optional($business)->business_email) }}">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                ...
                                <div class="form-row mb-20">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="business_number" class="form-control pl-1" placeholder="{{ __($business->business_number ?? 'Type your Business/Organization Contact Number.')}}" value="{{ old('business_number', optional($business)->business_number) }}">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                ...
                                <div class="form-row mb-20">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="seo_keywords"  class="form-control pl-1" placeholder="keywords must be comma seperated. eg; Africa, business solutions, " value="{{ old('seo_keywords', optional($business)->seo_keywords) }}">
                                    </div>
                                </div>
                                <!-- End Form Group -->
