                 ...
                 <div class="card-body bg-white mb-30">
                    ...
                    <div class="mail-header d-flex align-items-sm-center media flex-column flex-sm-row">
                       <div class="mail-header-left d-flex align-items-center position-relative">
                          ...
                          <!-- Unread Mail -->
                          <div class="unread">
                             <a href="#"><img src=" {{ asset('backend/assets/img/svg/mail.svg') }} " alt="" class="svg"></a>
                          </div>
                          <!-- End Unread Mail -->

                          <!-- Tag Mail -->
                          <div class="tag_mail">
                             <a href="#"><img src=" {{ asset('backend/assets/img/svg/tag.svg') }} " alt="" class="svg"></a>
                          </div>
                          <!-- End Tag Mail -->

                          <!-- Delete Mail -->
                          <div class="delete_mail">
                             <a href="#"><img src=" {{ asset('backend/assets/img/svg/delete.svg') }} " alt="" class="svg"></a>
                          </div>
                          <!-- End Delete Mail -->
                       </div>

                       <div class="mail-header-right d-flex align-items-center justify-content-end media-body mt-3 mt-sm-0">
                          <!-- Search Form -->
                          ...
                          <div class="pagination style--two d-flex flex-column align-items-center ml-3">
                             <ul class="list-inline d-inline-flex align-items-center">
                                <li><a href="#">
                                   <img src=" {{ asset('backend/assets/img/svg/left-angle.svg') }} " alt="" class="svg">
                                </a></li>
                                <li><a href="#" class="current">
                                   <img src=" {{ asset('backend/assets/img/svg/right-angle.svg') }} " alt="" class="svg">
                                </a></li>
                             </ul>
                          </div>
                          <!-- End Pagination -->
                       ...
                       <div class="d-flex justify-content-between align-items-sm-center media flex-column flex-sm-row">
                          <div class="d-flex align-items-center media-body position-relative">
                             ...
                             <a href="read.html" class="d-flex align-items-center mail-text">
                                <div class="avatar">
                                   <img src=" {{ asset('backend/assets/img/avatar/m5.png') }} " alt="">
                                </div>
                                <div class="content">
                    ...
                    <li class="mail-list-item">
                       <div class="d-flex justify-content-between align-items-sm-center media flex-column flex-sm-row">
                          <div class="d-flex align-items-center media-body position-relative">
                             ...
                             <a href="read.html" class="d-flex align-items-center mail-text">
                                <div class="avatar">
                                   <img src=" {{ asset('backend/assets/img/avatar/m7.png') }} " alt="">
                                </div>
                                <div class="content">
