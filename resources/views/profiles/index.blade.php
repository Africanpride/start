...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('profiles.model_plural') }}</h4>
            </div>
                ...
                <table class="table table-striped ">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('profiles.about') }}</th>
                            <th>{{ trans('profiles.user_id') }}</th>
                    ...
                    @foreach($profiles as $profile)
                        <tr>
                            <td>{{ $profile->name }}</td>
                            <td>{{ $profile->about }}</td>
                            <td>{{ optional($profile->user)->admin }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('profiles.profile.show', $profile->id ) }}" class="btn btn-info" title="{{ trans('profiles.show') }}">
